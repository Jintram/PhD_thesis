...
%a process that 
(which also generates energy to fuel the cell). % for the cell. % in the form of ATP.
%
...
%
To test this hypothesis we used a previously constructed \ecoli strain that lacked the metabolic feedback. % designed strain
...
%also including media supplemented with 
