...
\subsubsection*{A minimal model helps interpreting the cross-correlations}
...
%
The model suggests that metabolism-growth dynamics in wild type cells and any constitutive expression-growth dynamics are dominated by non-metabolism related fluctuations, whereas metabolism-growth dynamics in feedbackless $\Delta$cAMP cells are dominated by metabolic fluctuations.


The dynamic interaction between enzyme expression and growth (or protein expression in general and growth) can be modeled using a system of coupled differential equations.
%
