...
%
To test this hypothesis, we first subject the CRP system to artificial fluctuations in the cAMP system to see whether it can respond to such quick fluctuations.
%
...
To be able to assess the response of the CRP system, we firstly wanted to be able to measure its output.
%
...
%
This reporter construct uses a promoter of the lac operon from which the lacI binding site has been removed, see figure \ref{fig:CRP:fig0}.\red{X} and materials and methods for details.
This promoter is fused to a fluorescent reporter protein (either gfpmut2 or mVenus, depending on the experiment) to allow us to 
%estimate 
assess
