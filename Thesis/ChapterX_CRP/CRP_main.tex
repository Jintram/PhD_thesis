...
%
%And finally, it will be interesting to investigate the dynamical behavior of other regulatory systems
...
\textbf{Gel pad experiments.} \red{A detailed explanation of the experimental protocol for gel pad analysis can be found ...}
