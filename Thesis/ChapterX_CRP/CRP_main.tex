...
%
We suspected that CRP regulation might both respond to environmental and intracellular fluctuations.
%
...
%
We found a way to remove the (possible) response of the regulatory system to stochastic fluctuations, while maintaining the mean expression level required as response to the environment.
%
This was done by employing the $\Delta$cAMP strain that was grown in minimum medium supplemented with lactose and 800 $\upmu$M cAMP.
%
This concentration of cAMP resulted in growth rates that are comparable to those observed in wild type cells growing on lactose.
