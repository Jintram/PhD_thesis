...
% In principle, noise sources are additive, so an effect should be observed when it really takes away noise: addition of two independent noises is sigma1+sigma2 [wiki:Sum\_of\_normally\_distributed\_random\_variables], which makes sense since your basically kicking a "particle" twice as hard.)
%
