...
\begin{figure}
	\centering
	\includegraphics[width=1.0\textwidth]{png_chromo1prime_overview_custom_scatter_concentrationVsConcentrationYC.png}
	\includegraphics[width=1.0\textwidth]{png_chromo1prime_overview_custom_scatter_rateVsRateYC.png}	
	\caption{ 
