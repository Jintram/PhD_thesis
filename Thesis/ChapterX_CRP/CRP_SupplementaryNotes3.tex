...
%
$f_M(C_M)$ is a function of $C_M$, which describes \e{\lq{the regulation of the limiting enzyme for carbon uptake and catabolism by CRP}\rq{} \cite{Towbin2017}}. 
%
...
%
\e{The contributions of the left and right terms can be plotted separately to understand the dynamic behavior of the system when these terms change independently, see figure \ref{fig:CRP:benjamin_ODEs}.}
