...
%    Even if people have appalling views, a discussion with them
%    should be had on the premise they might be right.
% One cannot have a meaningful discussion without accepting a non-zero probability that one might not be right.
% ----------------------------------------
    \item 
...
% ----------------------------------------
    ...
    %       
        ...
        %For example, Mr. Fathersname1-Mothersname1 and Mrs. Fathersname2-Mothersname2 child
        %would carry the name Fathersname1-Mothersname2.        
        %one determined by the paternal line (as is now common),
        %and one determined by the maternal line.
        %
...
%    \item
%    \blue{
%    Any student or teacher should be made intimately familiar with scientific insights on how humans learn most effectively\footnote{
%        An excellent discussion of these insights can be found in the book \textit{Make it Stick - The Science of Successful Learning} by Peter C Brown (Harvard University Press, 2014).
%    }.
%    }
    % END REMOVED
    %Any study program should include a course that discusses scientific insights on how humans learn most effectively\footnote{An excellent argument for this is made in the %book \textit{Make it Stick - The Science of Successful Learning} by Peter C Brown (Harvard University Press, 2014).}.
    %
    % PROPOSITIONS REGARDING SCIENCE IN GENERAL
    % ----------------------------------------
    \item 
