...
%
During single cell experiments in the Tans lab that probed the effect of antibiotics on \ecoli bacteria we noticed a peculiarity. % \cite{RozendaalVerslagXXX}
%
