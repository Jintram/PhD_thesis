...
\captionof*{figure}{\textbf{Figure S2. Timing, length changes, and nucleoid imaging. Related to Figure 2.} 
...
\clearpage
\captionof*{figure}{
	\textbf{Figure S3. Division ring imaging. Related to Figure 3.}
...
\({D_E} = 0.2\).	\\
	\hline
\end{tabular}
		\captionof*{table}{\textbf{Table S1. Related to Figure 4.} Reaction rules used in the Meinhardt and De Boer [S4] simulations, see main text for a description.}
\end{minipage}
...
\hline
\end{tabular}
	\captionof*{table}{\textbf{Table S2. Related to Figure 4.} Reaction rules used in the Huang et al./Fange et al. [S2,S3] stochastic MesoRD model of the Min system, see main text for a description.}
\end{minipage}
