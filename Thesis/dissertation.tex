...
\usepackage{breakurl} % in combination with sloppy and fussy commands this should allow breackage of urls, but it didn't
...
\include{ChapterX_Literaturereview/ChapterX_Literaturereview}
